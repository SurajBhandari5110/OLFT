...
<body></body>
    <div class="container">
        ...
        <form action="{{ route('stays.update', $stay->pk_hotel_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" name="name" class="form-control" value="{{ $stay->name }}" required>
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea name="description" class="form-control" required>{{ $stay->description }}</textarea>
            </div>

            <div class="form-group">
                <label for="country">Country</label>
                <input type="text" name="country" class="form-control" value="{{ $stay->country }}" required>
            </div>

            <div class="form-group">
                <label for="state">State</label>
                <input type="text" name="state" class="form-control" value="{{ $stay->state }}" required>
            </div>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-success">Update Stay</button>
        </form>
    </div>
